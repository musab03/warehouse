...
const Hero = () => {
  return (
    <>
      <div className="max-w-[100rem] mx-auto px-4 sm:px-6 lg:px-8 mt-20 ">
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center ">
            ...
            {/* <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
              <div className="py-5">
                <div className="flex gap-x-1">
                  <svg
                    className="size-4 text-gray-800 :text-neutral-200"
                    width="51"
                    height="51"
                    viewBox="0 0 51 51"
                    fill="none"
                ...
                <p className="mt-3 text-sm text-gray-800 :text-neutral-200">
                  <span className="font-bold">4.6</span> /5 - from 12k reviews
                </p>

                <div className="mt-5">
                  <svg
                    className="h-auto w-16 text-gray-800 :text-white"
                    width="80"
                    height="27"
                    viewBox="0 0 80 27"
                    fill="none"
          ...
          <div className="relative ms-4">
            ...
            />
            <div className="absolute inset-0 -z-[1] bg-gradient-to-tr from-gray-200 via-white/0 to-white/0 size-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6 :from-neutral-800 :via-neutral-900/0 :to-neutral-900/0"></div>
